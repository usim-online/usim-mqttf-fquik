...
class ComposeViewModel @Inject constructor(
    ...
    private var fengniDisconnected = false
    ...
    override fun bindView(view: ComposeView) {
        ...
        view.cameraIntent
                ...
                .subscribe {
                    ...
                    context.makeToast(R.string.compose_text_only_notice)
                }
        ...
        view.attachImageFileIntent
            ...
            .autoDisposable(view.scope())
            .subscribe { context.makeToast(R.string.compose_text_only_notice) }
        ...
        view.sendIntent
            ...
            .withLatestFrom(
                ...
                // Guard: verify MQTT connectivity before sending via fengni
                if (QkTransaction.fengniSendHandler == null) {
                    fengniDisconnected = true
                    return@withLatestFrom false
                }
            ...
            .doOnNext { scheduled ->
                ...
                if (fengniDisconnected) {
                    context.makeToast(R.string.compose_mqtt_disconnected)
                    fengniDisconnected = false
                }
