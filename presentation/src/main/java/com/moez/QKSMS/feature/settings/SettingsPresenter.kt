        ...
        view.preferenceClicks()
                ...
                .subscribe {
                    ...
                    when (it.id) {
                        ...
                        R.id.longAsMms -> context.makeToast(R.string.compose_text_only_notice)

                        R.id.mmsSize -> context.makeToast(R.string.compose_text_only_notice)

                        R.id.messsageLinkHandling -> context.makeToast(R.string.compose_text_only_notice)
                        ...
                        R.id.fengniConfig -> navigator.showFengniConfigImport()
                    }
                }
