...
import com.moez.QKSMS.fengni.FengniConfigImportActivity
...
class Navigator @Inject constructor(
    ...
    fun showFengniConfigImport() {
        val intent = Intent(context, FengniConfigImportActivity::class.java)
        startActivity(intent)
    }

    fun showDeveloper() {
        // No-op: replaced with custom about page
    }

    fun showSourceCode() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/usim-online/usim-mqttf-fquik"))
        startActivityExternal(intent)
    }

    fun showChangelog() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://fquik.usim.online"))
        startActivityExternal(intent)
    }

    fun showLicense() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/usim-online/usim-mqttf-fquik/blob/main/LICENSE"))
        startActivityExternal(intent)
    }
    ...
    fun showRating() {
        ...
        try {
            ...
            val url = "https://github.com/usim-online/usim-mqttf-fquik"
    ...
    fun showSupport() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/usim-online/usim-mqttf-fquik/issues"))
        startActivityExternal(intent)
    }
    ...
    fun showInvite() {
        Intent(Intent.ACTION_SEND)
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT, "https://github.com/usim-online/usim-mqttf-fquik/releases/latest")
